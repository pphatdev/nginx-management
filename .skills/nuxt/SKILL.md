---
name: nuxt-nginx-deployment
summary: Deploy, operate, and troubleshoot Nuxt behind Nginx using either systemd or Docker Compose on Ubuntu.
---

# Nuxt + Nginx Deployment Skill

Use this skill when the user asks to:

- Deploy a Nuxt app behind Nginx
- Use Docker or non-Docker deployment paths
- Configure HTTPS and reverse proxy behavior
- Troubleshoot Nuxt/Nitro runtime and proxy issues
...
- State assumptions clearly (domain, ports, SSR mode, env vars).
